    ...
    <main className={`relative flex flex-col items-center font-sans transition-colors duration-500 ${theme.bg} ${theme.text}`}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none will-change-transform">
        ...
        {[
          ...
          >
            <i className={`fa-solid ${item.icon} ${item.size} ${item.color}`} style={{
              filter: 'blur(1px)',
              textShadow: isDark 
      ...
      <section className={`relative py-32 px-6 w-full border-t ${theme.border}`}>
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className={`text-5xl font-bold mb-4 ${theme.text}`}>
              Real-Time Performance Analytics
            </h2>
            <p className={`text-lg ${theme.textSecondary}`}>
              Data-driven insights that prove results
            </p>
          </motion.div>
      ...
      {/* Technology Stack */}
      <section className={`relative py-32 px-6 w-full ${isDark ? 'bg-gradient-to-b from-slate-950 to-slate-900' : 'bg-gradient-to-b from-white to-slate-50'} border-y ${theme.border}`}>
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Section */}
      <section className={`relative py-32 px-6 w-full ${isDark ? 'bg-gradient-to-b from-slate-900 to-slate-950' : 'bg-gradient-to-b from-slate-50 to-white'} border-t ${theme.border}`}>
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <h2 className={`text-6xl font-black mb-6 leading-tight ${theme.text}`}>
            Ready to <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Transform</span> Your Career?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <motion.button
              ...
              className={`px-10 py-5 ${isDark ? 'bg-slate-800 hover:bg-slate-700 border-slate-600' : 'bg-white hover:bg-slate-50 border-slate-300'} border-2 text-lg font-bold rounded-xl transition-all`}
            >
              View Demo
            </motion.button>
          </div>
